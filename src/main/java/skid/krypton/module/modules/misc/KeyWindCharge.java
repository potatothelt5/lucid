...
public final class KeyWindCharge extends Module {
    ...
    public KeyWindCharge() {
        super(EncryptedString.of("Key Wind Charge"), EncryptedString.of("Switches to a wind charge and throws it when you press a bind"), -1, Category.MISC);
    ...
    public void onTick(final TickEvent event) {
        ...
        if (this.isActivated) {
            ...
            InventoryUtil.swap(Items.WIND_CHARGE);
